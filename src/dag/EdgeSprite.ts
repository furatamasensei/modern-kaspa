...
export default class EdgeSprite extends PIXI.Container {
  private static readonly normalDefinition = new EdgeGraphicsDefinition(
    theme.components.edge.normal,
    false,
    false,
  )
  private static readonly inVirtualSelectedParentChainDefinition =
    new EdgeGraphicsDefinition(theme.components.edge.virtualChain, false, false)
  private static readonly highlightedParentDefinition =
    new EdgeGraphicsDefinition(
      theme.components.edge.highlighted.parent,
      true,
      false,
    )
  private static readonly highlightedChildDefinition =
    new EdgeGraphicsDefinition(
      theme.components.edge.highlighted.child,
      true,
      true,
    )
  private static readonly highlightedSelectedParentDefinition =
    new EdgeGraphicsDefinition(
      theme.components.edge.highlighted.selected,
      true,
      false,
    )
  private static readonly highlightedParentInVirtualSelectedParentChainDefinition =
    new EdgeGraphicsDefinition(
      theme.components.edge.highlighted.virtualChain.parent,
      true,
      false,
    )
  private static readonly highlightedChildInVirtualSelectedParentChainDefinition =
    new EdgeGraphicsDefinition(
      theme.components.edge.highlighted.virtualChain.child,
      true,
      true,
    )

  private static readonly definitionMap: {
    [definitionKey: string]: EdgeGraphicsDefinition
  } = EdgeSprite.initializeDefinitionMap()
  ...
  private static initializeDefinitionMap(): Record<
    string,
    EdgeGraphicsDefinition
  > {
    let definitionMap: { [definitionKey: string]: EdgeGraphicsDefinition } = {}
    definitionMap[EdgeSprite.normalDefinition.key()] =
      EdgeSprite.normalDefinition
    definitionMap[EdgeSprite.inVirtualSelectedParentChainDefinition.key()] =
      EdgeSprite.inVirtualSelectedParentChainDefinition
    definitionMap[EdgeSprite.highlightedParentDefinition.key()] =
      EdgeSprite.highlightedParentDefinition
    definitionMap[EdgeSprite.highlightedChildDefinition.key()] =
      EdgeSprite.highlightedChildDefinition
    definitionMap[EdgeSprite.highlightedSelectedParentDefinition.key()] =
      EdgeSprite.highlightedSelectedParentDefinition
    definitionMap[
      EdgeSprite.highlightedParentInVirtualSelectedParentChainDefinition.key()
    ] = EdgeSprite.highlightedParentInVirtualSelectedParentChainDefinition
    definitionMap[
      EdgeSprite.highlightedChildInVirtualSelectedParentChainDefinition.key()
    ] = EdgeSprite.highlightedChildInVirtualSelectedParentChainDefinition
  ...
  private renderGraphics = (
    ...
    definition: EdgeGraphicsDefinition,
  ) => {
    ...
    const baseLineWidth = theme.scale(
      this.baseDefinition!.lineWidth,
      this.blockSize,
    )
    const baseArrowRadius = theme.scale(
      this.baseDefinition!.arrowRadius,
      this.blockSize,
    )
    ...
    if (definition.isHighlight) {
      lineWidth = Math.max(
        lineWidth,
        baseLineWidth + theme.components.edge.highlighted.minBorderIncrease,
      )
      arrowRadius = Math.max(
        arrowRadius,
        baseArrowRadius +
          theme.components.edge.highlighted.minBorderIncrease * 0.5,
      )
    }
    ...
    if (definition.isHighlight) {
      ...
      const markRadius = theme.scale(
        theme.components.edge.highlighted.markRadius,
        this.blockSize,
      )
  ...
  setIsInVirtualSelectedParentChain = (
    isInVirtualSelectedParentChain: boolean,
  ) => {
    if (
      this.isInVirtualSelectedParentChain !== isInVirtualSelectedParentChain
