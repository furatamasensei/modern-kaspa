...
export const theme: Theme = {
  components: {
    block: {
      ...
      blue: {
        color: {
          main: 0x6ec7ba, // Stas original: 0xb4cfed,
    ...
    dag: {
      backgroundColor: 0x000000, // Stas original: 0xffffff
    ...
    edge: {
      ...
      virtualChain: {
        color: 0x6ec7ba, // Stas original: 0xb4cfed
        // https://fffuel.co/cccolor/ - 0x5581AA - Tint palette 3
  ...
  scale: (measure: number, blockSize: number): number => {
    return (
      (measure * blockSize) / theme.components.dag.scaling.referenceBlockSize
    )
  },
}
