    ...
    >
      <g id="Layer_1-2">
        ...
        <path
          fill="none"
          className="cls-1"
          d="m0,0v133.6h291.78V0H0Zm54.1,84.31l-4.96-6.49,14.81-11.41-14.81-11.4,4.96-6.49,16.89,13-2.31-15.6,8.07-1.2,3.2,21.69-3.2,21.7-8.07-1.2,2.31-15.6-16.89,13Z"
        ></path>
      </g>
    </svg>
  )
